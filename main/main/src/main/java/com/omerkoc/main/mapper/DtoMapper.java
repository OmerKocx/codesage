...
public class DtoMapper {
    ...
    public AnalysisResponse toResponse(Analysis analysis) {
        ...
        return AnalysisResponse.builder()
                ...
                .sourceFiles(analysis.getSourceFiles() != null ? 
                        analysis.getSourceFiles().stream().map(this::toResponse).collect(Collectors.toList()) : null)
                .issues(analysis.getIssues() != null ? 
                        analysis.getIssues().stream().map(this::toResponse).collect(Collectors.toList()) : null)
                .build();
    }
